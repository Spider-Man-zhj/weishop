...
public class AutoGeneratorHelper {
	 public static void main(String[] args) {
	        ...
	        strategy.setInclude(new String[]{"tb_address","tb_admin_role","tb_areas","tb_brand","tb_cities","tb_content",
	        		"tb_content_category","tb_goods","tb_goods_desc","tb_item","tb_item_cat","tb_order","tb_order_item",
	        		"tb_pay_log","tb_permission","tb_provinces","tb_role","tb_role_permission","tb_seckill_goods","tb_seckill_order",
	        		"tb_seller","tb_seller_type","tb_specification","tb_specification_option","tb_theme","tb_user"});
